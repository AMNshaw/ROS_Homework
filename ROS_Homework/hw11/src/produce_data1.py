...
with open('/home/amnshaw/catkin_ws/src/Homework/hw11/src/output.csv', 'w') as csvfile:
  writer = csv.writer(csvfile)
  writer.writerow(num_list)
  writer.writerow(receve_list)

with open('/home/amnshaw/catkin_ws/src/Homework/hw11/src/data.csv', 'r') as csvfile:
